...
var _enableReferencedModulesTelemetry = false
...
var _afDefaults = {
  baseUniqueName: ''
  location: location
  enableTelemetry: _enableReferencedModulesTelemetry
  aiProjects: []
  aiModelDeployments: [
    {
      name: 'chat'
...
module bingSearch 'components/bing-search/main.bicep' = if (_invokeBingModule) {
