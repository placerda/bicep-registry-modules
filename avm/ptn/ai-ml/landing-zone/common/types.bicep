...
type apimDefinitionType = {
  ...
  @description('Optional. Portal settings for the developer portal. Allowed names: signin, signup, delegation.')
  portalsettings: {
    @description('Required. The name of the portal-setting. Allowed values: signin, signup, delegation.')
    name: 'signin' | 'signup' | 'delegation'

    @description('Required. The portal-settings contract properties. Shape depends on the "name".')
    properties: {
  ...
  @description('Optional. SKU of the API Management service. Allowed values: Consumption, Developer, Basic, Standard, Premium.')
...
@export()
@description('Container App (open).')
type containerAppDefinitionType = object
...
type publicIpDefinitionType = {
  ...
  @description('Optional. List of availability zones for the Public IP Address allocation. Allowed values: 1, 2, 3.')
